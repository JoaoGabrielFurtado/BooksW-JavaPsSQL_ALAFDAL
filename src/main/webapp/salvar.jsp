...
<%
    ...
    try {
        Codigo.ALDAL.set(umLivro);
        
        if (Erro.getErro()) {
            temErro = true;
            mensagemH1 = "Ocorreu um erro ao salvar:";
            mensagemP = Erro.getMens(); 
        } else {
            temErro = false;
            mensagemH1 = "Livro cadastrado com SUCESSO";
            mensagemP = "'" + umLivro.getTitulo() + "' foi salvo no banco de dados.";
        }
